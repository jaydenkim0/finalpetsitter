			...
			<c:choose>				
				<c:when test="${member.grade eq 'petsitter' && member.black_count > 0}">
					<tr>
						<td>
							...
							<td style="color:red;"> ${member.nick} </td>
							<td style="color:red;"> ${member.email} </td>
							<td style="color:red;"> (${member.black_count}) </td>
					</tr>					
				</c:when>				
				<c:when test="${member.grade eq 'member' && member.black_count > 0}">
					<tr>
						...
						<td style="color:#ff8d00;"> ${member.name} </td>
						<td style="color:#ff8d00;"> ${member.nick} </td>
						<td style="color:#ff8d00;"> ${member.email} </td>
						<td style="color:#ff8d00;"> (${member.black_count}) </td>							
					</tr>						
				</c:when>					
				<c:otherwise>
					<tr>
