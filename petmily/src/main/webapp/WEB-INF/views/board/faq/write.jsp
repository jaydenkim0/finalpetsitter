...
<form method="post" action="insert" enctype="multipart/form-data">
	...
	<table border="1" width="70%">
		...
		<br>
		<div>
			제목<input name="faq_head" id="faq_head" size="80"
				placeholder="글 제목 입력">
		</div>
		<br>
		<div>
			내용
			<textarea name="faq_content" id="faq_content" rows="8" cols="80"
				placeholder="글 내용 입력"></textarea>
		</div>
		<div>
			이미지 첨부 <input type="file" id="faq_file" name="faq_file" multiple
