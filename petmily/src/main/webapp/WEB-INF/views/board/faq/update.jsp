...
<form name="update" method="post" action="${context}/board/faq/update">
	...
	<div>글 번호</div>
	<div>
		<input name="faq_no" value="${faqVO.faq_no}" type="number"
			readonly="readonly">
	</div>

	<div>작성자</div>
	<div>
		<input name="member_id" value="${faqVO.member_id}" type="text"
			readonly="readonly">
	</div>
	...
	<div>내용 :</div>
	<div>
		<input name="faq_content" value="${faqVO.faq_content}" type="text">
	</div>
