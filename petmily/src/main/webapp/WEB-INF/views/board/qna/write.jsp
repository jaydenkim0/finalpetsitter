...
<form method="post" action="insert" enctype="multipart/form-data">
      <input type="hidden" name="qna_writer" value="${sessionScope.id}">
        ...
        <br>
        <div>제목<input name="qna_head" id="qna_head" size="80" placeholder="글 제목 입력"></div><br>
        <div>내용<textarea name="qna_content" id="qna_content" rows="8" cols="80" placeholder="글 내용 입력"></textarea></div>
        <div>이미지 첨부
        <input type="file" id="qna_file" name="qna_file" multiple accept="image/*" required>
        </div>
